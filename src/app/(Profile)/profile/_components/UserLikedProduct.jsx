  ...
  return (
    <div className="flex min-h-32 flex-col gap-1 rounded-lg border border-secondary-200 p-2 shadow-md">
      <div className="flex items-start justify-between gap-4">
        {/* Product Info */}
        <div className="flex h-[-webkit-fill-available] flex-1 flex-col justify-between gap-6">
          <div className="mb-2 flex h-full flex-col justify-between gap-2">
            {/* Product Title */}
            <div>
              <Link href={`/products/${product.slug}`}>
                <h3 className="mb-2 max-w-56 truncate text-lg font-bold text-secondary-900 transition-all duration-200 hover:text-primary-900">
                  {product.title}
                </h3>
              </Link>
